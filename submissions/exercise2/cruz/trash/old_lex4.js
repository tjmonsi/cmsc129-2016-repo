...
function compile(){
	...
	//implementing character "sinkhole" to generate words
	// var charSH = new State(null, false);
	// for (var i = 65; i <= 90; i++) {	//Capital
	// 	var char = new State(String.fromCharCode(i), true);
	// 	char.type = "word";
	// 	charSH.next[char.character]=char;
	// 	sStart.next[String.fromCharCode(i)].type = "word";
	// 	sStart.next[String.fromCharCode(i)].accept = true;
	// }
	// for (var i = 97; i <= 122; i++) {	//Small
	// 	var char = new State(String.fromCharCode(i), true);
	// 	char.type = "word";
 ...
 // 	for (var i = 65; i <= 90; i++) {	//Capital connect
	// 	for (var j = 65; j <= 90; j++) {
	// 		sStart.next[String.fromCharCode(i)].addNext(charSH.next[String.fromCharCode(j)]);
	// 		charSH.next[String.fromCharCode(i)].addNext(charSH.next[String.fromCharCode(j)]);
	// 	}
	// 	for (var j = 97; j <= 122; j++) {
	// 		sStart.next[String.fromCharCode(i)].addNext(charSH.next[String.fromCharCode(j)]);
	// 		charSH.next[String.fromCharCode(i)].addNext(charSH.next[String.fromCharCode(j)]);
	// 	}
	// }
	// for (var i = 97; i <= 122; i++) {	//Small connect
	// 	for (var j = 65; j <= 90; j++) {
	// 		sStart.next[String.fromCharCode(i)].addNext(charSH.next[String.fromCharCode(j)]);
	// 		charSH.next[String.fromCharCode(i)].addNext(charSH.next[String.fromCharCode(j)]);
	// 	}
